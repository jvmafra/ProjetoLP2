...
public class EditaHospede extends JPanel {
	...
	public EditaHospede(Hospede h) {
		...
		JLabel lblNewLabel = new JLabel(new ImageIcon(EditaHospede.class.getResource("/nucleo/icones/hotel4.png")));
		...
		add(btnBuscaCep);
		//setFocusTraversalPolicy(new FocusTraversalOnArray(new Component[]{nome, idade, cpf, nome_1, cpf_1, rg_1, rg, idade_1, email_1, email, endereco_1, endereco, telefone_1, telefone, numCartao_1, numCartao, btnVoltar, btnSalvar, lblNewLabel, txtCep, lbCEP, btnBuscaCep}));
